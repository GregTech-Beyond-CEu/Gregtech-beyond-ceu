...
eventManager.listen {
    ...
    PostMaterialEvent event ->
        ...
        customMetaItems.addItem(465, "electron_source_casing");
        customMetaItems.addItem(466, "drenched_phenolic_circuit_board");
        customMetaItems.addItem(467, "patterned_plastic_board");
        customMetaItems.addItem(468, "drenched_plastic_board");
        customMetaItems.addItem(469, "sod_323_packaging");
        customMetaItems.addItem(470, "quantum_smd_diode_chips");
        customMetaItems.addItem(471, "quantum_smd_inductor_chips");
        customMetaItems.addItem(472, "quantum_smd_transistor_chips");
        customMetaItems.addItem(473, "quantum_smd_resistor_chips");
        customMetaItems.addItem(474, "quantum_smd_capacitor_chips");
        customMetaItems.addItem(475, "passivated_quantum_smd_wafer");
        customMetaItems.addItem(476, "aluminium_layered_ga_as_wafer");
        customMetaItems.addItem(477, "gold_layered_ga_as_wafer");
        customMetaItems.addItem(478, "mesa_structured_ga_as_wafer");
        customMetaItems.addItem(479, "engraved_doped_ga_as_wafer");
        customMetaItems.addItem(480, "heavily_doped_ga_as_wafer");
        customMetaItems.addItem(481, "atomic_layered_substrate");
        customMetaItems.addItem(482, "etched_exposed_substrate");
        customMetaItems.addItem(483, "exposed_substrate");
        customMetaItems.addItem(484, "deionized_substrate");
        customMetaItems.addItem(485, "spincoated_substrate");
        customMetaItems.addItem(486, "thin_kapton_k_sheet");
        customMetaItems.addItem(487, "top_electrode_deposited_substrate");
        customMetaItems.addItem(488, "dielectric_electrode_substrate");
        customMetaItems.addItem(489, "graphene_electrode_substrate");
        customMetaItems.addItem(490, "annealed_ga_as_wafer");
        customMetaItems.addItem(491, "atomic_layered_ga_as_wafer");
        customMetaItems.addItem(492, "developed_ga_as_wafer");
        customMetaItems.addItem(493, "engraved_spincoated_ga_as_wafer");
        customMetaItems.addItem(494, "resistor_lithography_mask");
        customMetaItems.addItem(495, "spincoated_resistivated_ga_as_wafer");
        customMetaItems.addItem(496, "resistivated_ga_as_wafer");
        customMetaItems.addItem(497, "cleaned_doped_ga_as_wafer");
        customMetaItems.addItem(498, "annealed_layered_substrate");
        customMetaItems.addItem(499, "metal_layered_substrate");
        customMetaItems.addItem(500, "gated_substrate");
        customMetaItems.addItem(501, "etched_substrate");
        customMetaItems.addItem(502, "engraved_substrate");
        customMetaItems.addItem(503, "quantum_well_substrate");
        customMetaItems.addItem(504, "electron_source_100kv");
        customMetaItems.addItem(505, "steel_source_casing");
        customMetaItems.addItem(506, "quantum_smd_diode");
        customMetaItems.addItem(507, "quantum_smd_transistor");
        customMetaItems.addItem(508, "quantum_smd_capacitor");
        customMetaItems.addItem(509, "quantum_smd_inductor");
        customMetaItems.addItem(510, "quantum_smd_resistor");
        customMetaItems.addItem(511, "pressed_tantalum_pellet");
        customMetaItems.addItem(512, "porous_sintered_pellet");
        customMetaItems.addItem(513, "oxidized_anode");
        customMetaItems.addItem(514, "tantalum_cap_core");
        customMetaItems.addItem(515, "tantalum_capacitor");
        customMetaItems.addItem(516, "zener_junction_core");
        customMetaItems.addItem(517, "zener_diode_die");
        customMetaItems.addItem(518, "precision_resistor_array");
        customMetaItems.addItem(519, "crystal_oscillator");
        customMetaItems.addItem(520, "voltage_reference_core");
        customMetaItems.addItem(521, "op_amp_circuit");
        customMetaItems.addItem(522, "stabilized_voltage_regulator_board");
        customMetaItems.addItem(523, "yttrium_barium_cuprate_coil");
        customMetaItems.addItem(524, "oscillating_quartz_blank");
        customMetaItems.addItem(525, "crystal_oscillator_circuit");
        customMetaItems.addItem(526, "spincoated_deposited_alumina_wafer");
        customMetaItems.addItem(527, "etched_electrode_deposited_ga_as_substrate");
        customMetaItems.addItem(528, "fused_quartz_panel");
        customMetaItems.addItem(529, "carbon_carbon_plate");
        customMetaItems.addItem(530, "piezoelectric_actuator");
        customMetaItems.addItem(531, "superalloy_bearing");
        customMetaItems.addItem(532, "gyroscope_chip");
        customMetaItems.addItem(533, "advanced_nozzle");
        customMetaItems.addItem(534, "turbo_pump_assembly");
        customMetaItems.addItem(535, "cryogenic_fuel_lines");
        customMetaItems.addItem(536, "thermal_control_loop");
        customMetaItems.addItem(538, "cryogenic_pump");
        customMetaItems.addItem(539, "superalloy_impeller");
        customMetaItems.addItem(540, "cryogenic_pump_housing");
        customMetaItems.addItem(541, "high_reliability_memory_bank");
        customMetaItems.addItem(542, "thermal_sensor_array");
        customMetaItems.addItem(543, "mems_sensor_array");
        customMetaItems.addItem(544, "ring_laser_diode");
        customMetaItems.addItem(545, "gyro_mounting_device");
        customMetaItems.addItem(546, "quantum_logic_ic");
        customMetaItems.addItem(547, "quantum_clock_module");
        customMetaItems.addItem(548, "impeller_core");
        customMetaItems.addItem(554, "precision_laser_sensor");
        customMetaItems.addItem(555, "ytterbium_ion_trap");
        customMetaItems.addItem(556, "ultra_stable_laser_array");
        customMetaItems.addItem(557, "cryogenic_cooling_unit");
        customMetaItems.addItem(558, "uv_laser_lens");
        customMetaItems.addItem(559, "etched_silicon_dioxide_wafer");
        customMetaItems.addItem(560, "evaporated_silicon_dioxide_wafer");
        customMetaItems.addItem(561, "zone_refined_sapphire_wafer");
        customMetaItems.addItem(562, "indium_gallium_arsenide_wafer");
        customMetaItems.addItem(563, "thermophile_chip");
        ...
        customMetaItems.addItem(573, "alumina_heat_spreader");
        customMetaItems.addItem(574, "not_gate");
        customMetaItems.addItem(575, "and_gate");
        customMetaItems.addItem(576, "or_gate");
