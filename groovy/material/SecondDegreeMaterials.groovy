...
public class SecondDegreeMaterials {
  ...
  public static void register() {
        ...
        VeryHotAquaRegia = new Material.Builder(10089, GTBUtil.gtb("very_hot_aqua_regia"))
                .fluid()
                .color(0xF9A825)
                .build().setFormula("(HNO3)(HCl)3", true);
        ...
        GalliumTrichloride = new Material.Builder(10124, GTBUtil.gtb("gallium_trichloride"))
                .fluid()
                .color(0x88A7AA)
                .build().setFormula("GaCl3", true);

        MagnesiumBromideChlorideSalt = new Material.Builder(10125, GTBUtil.gtb("magnesium_bromide_chloride_salt"))
                .dust()
                .color(0xC8A9AC)
                .build().setFormula("MgBrCl", true);

        MagnesiumHydroxide = new Material.Builder(10126, GTBUtil.gtb("magnesium_hydroxide"))
                .fluid()
                .color(0xF7D7DA)
                .build().setFormula("MgOH", true);

        SodiumMetaphosphate = new Material.Builder(10127, GTBUtil.gtb("sodium_metaphosphate"))
                .dust()
                .color(0xCCBE46)
                .iconSet(ROUGH)
                .build().setFormula("NaPO", true);

        MagnesiumHydroxide = new Material.Builder(10128, GTBUtil.gtb("magnesium_hydroxide"))
                .dust()
                .color(0xC9B9CC)
                .build().setFormula("MgOH", true);

        PhosphorusTriiodide = new Material.Builder(10129, GTBUtil.gtb("phosphorus_triiodide"))
                .dust()
                .color(0x8A8668)
                .build().setFormula("PI3", true);

        PhosphorousAcid = new Material.Builder(10130, GTBUtil.gtb("phosphorous_acid"))
                .fluid()
                .color(0x8A8668)
                .build().setFormula("H3PO3", true);

        RadonContainingNobleGasses = new Material.Builder(10131, GTBUtil.gtb("radon_containing_noble_gasses"))
                .fluid()
                .color(0xC685D2)
                .build().setFormula("Rn?", true);

        RadonRichAir = new Material.Builder(10132, GTBUtil.gtb("radon_rich_air"))
                .fluid()
                .color(0xBC8EC4)
                .build().setFormula("Rn?", true);

        ChilledRadonRichAir = new Material.Builder(10133, GTBUtil.gtb("chilled_radon_rich_air"))
                .fluid()
                .color(0xA77FAD)
                .build().setFormula("Rn?", true);

        OlefinMixture = new Material.Builder(10134, GTBUtil.gtb("olefin_mixture"))
                .fluid()
                .color(0xC47158)
                .build();

        Octene = new Material.Builder(10135, GTBUtil.gtb("1_octene"))
                .fluid()
                .color(0xB34E2F)
                .build().setFormula("C8H16", true);

        Dodecene = new Material.Builder(10136, GTBUtil.gtb("1_dodecene"))
                .fluid()
                .color(0xB94B2A)
                .build().setFormula("C12H24", true);

        Hexene = new Material.Builder(10137, GTBUtil.gtb("1_hexene"))
                .fluid()
                .color(0xBA5334)
                .build().setFormula("C6H12", true);

        Decene = new Material.Builder(10138, GTBUtil.gtb("1_decene"))
                .fluid()
                .color(0xB64C2C)
                .build().setFormula("C10H20", true);

        ZirconylChloride = new Material.Builder(10139, GTBUtil.gtb("zirconyl_chloride"))
                .dust()
                .color(0xC9B7CD)
                .build().setFormula("ZrOCl2", true);

        PurifiedDecene = new Material.Builder(10141, GTBUtil.gtb("purified_1_decene"))
                .fluid()
                .color(0xAA4628)
                .build().setFormula("C10H20", true);

        LeachedCobaltSolution = new Material.Builder(10142, GTBUtil.gtb("leached_cobalt_solution"))
                .fluid()
                .color(0x1E609A)
                .build().setFormula("Co?", true);

        PregnantCobaltLeach = new Material.Builder(10143, GTBUtil.gtb("pregnant_cobalt_leach"))
                .fluid()
                .color(0x2B699F)
                .build().setFormula("Co?", true);

        CobaltLeach = new Material.Builder(10144, GTBUtil.gtb("cobalt_leach"))
                .fluid()
                .color(0x3A6285)
                .build().setFormula("Co?", true);

        NickelLeach = new Material.Builder(10145, GTBUtil.gtb("nickel_leach"))
                .fluid()
                .color(0xD2BC9F)
                .build().setFormula("Ni?", true);

        NeutralizedCobaltLeachSolution = new Material.Builder(10146, GTBUtil.gtb("neutralized_cobalt_leach_solution"))
                .fluid()
                .color(0x3F6880)
                .build().setFormula("CoNi?", true);

        LeachedCobaltLeachSolution = new Material.Builder(10147, GTBUtil.gtb("leached_cobalt_leach_solution"))
                .fluid()
                .color(0x1E5576)
                .build().setFormula("CoNi?", true);

        Isopentane = new Material.Builder(10148, GTBUtil.gtb("isopentane"))
                .fluid()
                .color(0xC85B39)
                .build().setFormula("C5H12", true);

        AlluminiumGalliumArsenide = new Material.Builder(10149, GTBUtil.gtb("aluminium_gallium_arsenide"))
                .fluid()
                .color(0x7AB1DE)
                .build().setFormula("AlGaAs", true);

        CadmiumMagnesiumTellurium = new Material.Builder(10150, GTBUtil.gtb("cadmium_magnesium_tellurium"))
                .dust()
                .color(0x7EB580)
                .build().setFormula("CdMgTe", true);

        DilutedHydrofluoricAcid = new Material.Builder(10151, GTBUtil.gtb("diluted_hydrofluoric_acid"))
                .fluid()
                .color(0x9DC9EC)
                .build().setFormula("HF(H2O)", true);

        Diborane = new Material.Builder(10152, GTBUtil.gtb("diborane"))
                .fluid()
                .color(0x90A8BC)
                .build().setFormula("B2H6", true);

        ManganeseDioxide = new Material.Builder(10153, GTBUtil.gtb("manganese_dioxide"))
                .dust()
                .color(0xD9BEB5)
                .build().setFormula("MgO2", true);

        MeteoricIron = new Material.Builder(10154, GTBUtil.gtb("meteoric_iron"))
                .dust()
                .ingot()
                .flags(GENERATE_DOUBLE_PLATE, GENERATE_PLATE)
                .color(0x6E6868)
                .build().setFormula("Fe*", true);

        IridiumAlloy = new Material.Builder(10155, GTBUtil.gtb("iridium_alloy"))
                .dust()
                .ingot()
                .flags(GENERATE_DOUBLE_PLATE, GENERATE_PLATE)
                .color(0xD4D3D3)
                .build().setFormula("IrPtOsRu", true);

        ThermalPasteCompound = new Material.Builder(10156, GTBUtil.gtb("thermal_paste_compound"))
                .dust()
                .color(0x7FBFE2)
                .build();

        SiliconeOil = new Material.Builder(10157, GTBUtil.gtb("silicone_oil"))
                .fluid()
                .color(0xD6D4C7)
                .build();

        XenonDifluoride = new Material.Builder(10158, GTBUtil.gtb("xenon_difluoride"))
                .fluid()
                .color(0xC8A7CE)
                .build().setFormula("XeF2");

        ManganeseZincFerrite = new Material.Builder(10159, GTBUtil.gtb("manganese_zinc_ferrite"))
                .dust()
                .flags(GENERATE_PLATE)
                .color(0xCFBDBD)
                .build().setFormula("MnZnFe");

        NanothermalPaste = new Material.Builder(10160, GTBUtil.gtb("nanothermal_paste"))
                .dust()
                .color(0x4C4C4D)
                .build();

        TungstenRhenium = new Material.Builder(10161, GTBUtil.gtb("tungsten_rhenium"))
                .dust()
                .ingot()
                .flags(GENERATE_PLATE)
                .color(0x6C839D)
                .build().setFormula("WRh");

        BoronNitride = new Material.Builder(10162, GTBUtil.gtb("boron_nitride"))
                .dust()
                .color(0xB7C9B7)
                .build().setFormula("BN", true);

        TetraethylOrthosilicate = new Material.Builder(10163, GTBUtil.gtb("tetraethyl_orthosilicate"))
                .fluid()
                .color(0x7A6B6B)
                .build().setFormula("Si(OC2H5)4", true);

        BoronTrifluoride = new Material.Builder(10164, GTBUtil.gtb("boron_trifluoride"))
                .fluid()
                .color(0x709071)
                .build().setFormula("BF3", true);

        LithiumHydride = new Material.Builder(10165, GTBUtil.gtb("lithium_hydride"))
                .dust()
                .color(0x7692A9)
                .build().setFormula("LiH", true);

        LithiumAluminiumHydrideSolution = new Material.Builder(10166, GTBUtil.gtb("lithium_aluminium_hydride_solution"))
                .fluid()
                .color(0xEAAB43)
