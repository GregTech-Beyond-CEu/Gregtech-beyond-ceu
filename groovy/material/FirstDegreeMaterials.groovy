...
public class FirstDegreeMaterials {
  ...
  public static void register() {
        ...
        ElectronDegenerateRheniumPlasma = new Material.Builder(8064,GTBUtil.gtb("electron_degenerate_rhenium_plasma"))
                .fluid()
                .color(0x7986CB)
                .build().setFormula("Re-", true);
        ...
        ChloronaquadicAcid = new Material.Builder(8086, GTBUtil.gtb("chloronaquadic_acid"))
                .fluid()
                .color(0x616161)
                .build().setFormula("Nq(HNO3)(HCl)3", true);
        ...
        SodiumSulfideDichloroBenzeneMixture = new Material.Builder(8110,GTBUtil.gtb("sodium_sulfide_solution_dichloro_benzene_mixture"))
                 .fluid()
                .color(0x635E46)
        ...
        DisproportionatedChloroSilane = new Material.Builder(8112,GTBUtil.gtb("disproportionated_chloro_silane"))
                .fluid()
                .color(0xD7E8F0)
                .build().setFormula("HClSi", true);
        ...
        RecrystallizedZirconiumDioxide = new Material.Builder(8137,GTBUtil.gtb("recrystallized_zirconium_dioxide"))
                .dust()
                .color(0xAA245F)
        ...
        OneButane = new Material.Builder(8141,GTBUtil.gtb("one_butane"))
                .fluid()
                .color(0x995C57)
        ...
        FluorohydrideAmmoniumCarbama = new Material.Builder(8143,GTBUtil.gtb("fluorohydride_ammonium_carbama"))
                .fluid()
                .color(0x729A74)
                .build().setFormula("HF(NH3)N2O", true);
        ...
        // fluid
        ThionylChloride = new Material.Builder(8183, GTBUtil.gtb("thionyl_chloride"))
                .fluid()
                .color(0x79A29F)
                .build().setFormula("SOCl2", true);

        SuccinicAcid = new Material.Builder(8184, GTBUtil.gtb("succinic_acid"))
                .dust()
                .color(0xEDCD3B)
                .build().setFormula("C4H6O4", true);

        EthylBenzene = new Material.Builder(8185, GTBUtil.gtb("ethyl_benzene"))
                .fluid()
                .color(0x7D7C79)
                .build().setFormula("C8H10", true);

        Naphthaldehyde = new Material.Builder(8186, GTBUtil.gtb("naphthaldehyde"))
                .fluid()
                .color(0xF3D036)
                .build().setFormula("C10H7CHO", true);

        HydrobromicAcid = new Material.Builder(8187, GTBUtil.gtb("hydrobromic_acid"))
                .fluid()
                .color(0xE89089)
                .build().setFormula("HBr", true);

        Dimethylsulfide = new Material.Builder(8190, GTBUtil.gtb("dimethylsulfide"))
                .fluid()
                .color(0xCD9ED4)
                .build().setFormula("C2H6S", true);

        Methylamine = new Material.Builder(8191, GTBUtil.gtb("methylamine"))
                .fluid()
                .color(0x9C53A8)
                .build().setFormula("CH3NH2", true);

        Ferrocenylfulleropyrrolidine = new Material.Builder(8192,GTBUtil.gtb("ferrocenylfulleropyrrolidine"))
                .fluid()
                .color(0x151415)
                .build().setFormula("C70H31FeN", true);

        Iron2Chloride = new Material.Builder(8193, GTBUtil.gtb("iron_2_chloride"))
                .fluid()
                .color(0x494553)
                .build().setFormula("FeCl2", true);

        AcryloNitrile = new Material.Builder(8194, GTBUtil.gtb("acrylo_nitrile"))
                .fluid()
                .color(0xC9C6A5)
                .build().setFormula("C3H3N", true);

        HydroiodicAcid = new Material.Builder(8195, GTBUtil.gtb("hydroiodic_acid"))
                .fluid()
                .color(0x666CA5)
                .build().setFormula("HI", true);

        Hydrazine = new Material.Builder(8196, GTBUtil.gtb("hydrazine"))
                .fluid()
                .color(0x7DB3E3)
                .build().setFormula("N2H4", true);

        BenzoylPeroxide = new Material.Builder(8197, GTBUtil.gtb("benzoyl_peroxide"))
                .fluid()
                .color(0x31516D)
                .build().setFormula("C14H10O4", true);

        BenzoylChloride = new Material.Builder(8198, GTBUtil.gtb("benzoyl_chloride"))
                .fluid()
                .color(0x324834)
                .build().setFormula("C7H5ClO", true);

        IronChloride = new Material.Builder(8199, GTBUtil.gtb("iron_chloride"))
                .fluid()
                .color(0x2A5170)
                .build().setFormula("FeCl", true);

        Dichloromethane = new Material.Builder(8200, GTBUtil.gtb("dichloromethane"))
                .fluid()
                .color(0x725E76)
                .build().setFormula("CH2Cl2", true);

        Dimethylaminopyridine = new Material.Builder(8201, GTBUtil.gtb("dimethylaminopyridine"))
                .dust()
                .color(0xFFA000)
                .build().setFormula("C7H10N2", true);

        Pyridine = new Material.Builder(8202, GTBUtil.gtb("pyridine"))
                .fluid()
                .color(0xFE9F01)
                .build().setFormula("C5H5N", true);

        Diisopropylcarbodiimide = new Material.Builder(8203, GTBUtil.gtb("diisopropylcarbodiimide"))
                .fluid()
                .color(0xD32F2F)
                .build().setFormula("(CH3)2CHN=C=NCH(CH3)2", true);

        IsopropylAlcohol = new Material.Builder(8204, GTBUtil.gtb("isopropyl_alcohol"))
                .fluid()
                .color(0xA4B1A5)
                .build().setFormula("C3H8O", true);

        Silvertetrafluoroborate = new Material.Builder(8205, GTBUtil.gtb("silvertetrafluoroborate"))
                .fluid()
                .color(0xDADBDA)
                .build().setFormula("AgBF4", true);

        TrimethyltinChloride = new Material.Builder(8206, GTBUtil.gtb("trimethyl_tin_chloride"))
                .fluid()
                .color(0x7986CB)
                .build().setFormula("C3H9SnCl", true);

        Phenylpentanoicacid = new Material.Builder(8207, GTBUtil.gtb("phenylpentanoicacid"))
                .fluid()
                .color(0xFCF2DC)
                .build().setFormula("C11H14O2", true);

        // dusts
        Fullerene = new Material.Builder(8208, GTBUtil.gtb("fullerene"))
                .dust()
                .color(0xF9D16E)
                .build().setFormula("C60", true);

        TiAlChloride = new Material.Builder(8209, GTBUtil.gtb("ti_al_chloride"))
                .dust()
                .color(0x1E88E5)
                .build().setFormula("TiAlCl3", true);

        UnfoldedFullerene = new Material.Builder(8210, GTBUtil.gtb("unfolded_fullerene"))
                .dust()
                .color(0x4527A0)
                .build().setFormula("C60", true);

        Succinimide = new Material.Builder(8211, GTBUtil.gtb("succinimide"))
                .dust()
                .color(0x163217)
                .build()
                .setFormula("C4H5NO2", true);

        PotassiumBromide = new Material.Builder(8212, GTBUtil.gtb("potassium_bromide"))
                .dust()
                .color(0xDEBDBD)
                .build().setFormula("KBr", true);

        Benzophenanthrenylacetonitrile = new Material.Builder(8213,GTBUtil.gtb("benzophenanthrenylacetonitrile"))
                .dust()
                .color(0xC62828)
                .build().setFormula("?", true);
        Bromosuccinimide = new Material.Builder(8214, GTBUtil.gtb("bromosuccinimide"))
                .dust()
                .color(0x315458)
                .build().setFormula("C4H4BrNO2", true);

        PotassiumCyanide = new Material.Builder(8215, GTBUtil.gtb("potassium_cyanide"))
                .dust()
                .color(0xFFCA28)
                .build().setFormula("KCN", true);

        Methylbenzophenanthrene = new Material.Builder(8216, GTBUtil.gtb("methylbenzophenanthrene"))
                .dust()
                .color(0x327F89)
                .build().setFormula("C18H12", true);

        TinChloride = new Material.Builder(8217, GTBUtil.gtb("tin_chloride"))
                .dust()
                .color(0x9A8FBA)
                .build().setFormula("SnCl4", true);

        DisodiumPhosphate = new Material.Builder(8218, GTBUtil.gtb("disodium_phosphate"))
                .dust()
                .color(0x3A77AD)
                .build().setFormula("Na2HPO4", true);

        Cyanonaphthalene = new Material.Builder(8219, GTBUtil.gtb("cyanonaphthalene"))
                .dust()
                .color(0x554B67)
                .build().setFormula("C10H7CN", true);

        SodiumBromide = new Material.Builder(8220, GTBUtil.gtb("sodium_bromide"))
                .dust()
                .color(0x837798)
                .build().setFormula("NaBr", true);

        PotassiumPermanganate = new Material.Builder(8221, GTBUtil.gtb("potassium_permanganate"))
                .dust()
                .color(0xE6EE9C)
                .build().setFormula("KMnO4", true);

        PdFullereneMatrix = new Material.Builder(8222, GTBUtil.gtb("palladium_fullerene_matrix"))
                .dust()
                .color(0x4527A0)
                .build().setFormula("PdC73H15NFe", true);

        AluminoSilicateWool = new Material.Builder(8223, GTBUtil.gtb("alumino_silicate_wool"))
                .dust()
                .color(0x4DD0E1)
                .build().setFormula("Al2SiO5", true);

        Sarcosine = new Material.Builder(8224, GTBUtil.gtb("sarcosine"))
                .dust()
                .color(0x3D8540)
                .build().setFormula("C3H7NO2", true);

        Ferrocene = new Material.Builder(8225, GTBUtil.gtb("ferrocene"))
                .fluid()
                .color(0xD1C4E9)
                .build().setFormula("C10H10Fe", true);

        PdIrReOCeOS = new Material.Builder(8226, GTBUtil.gtb("pd_ir_re_o_ce_o_s"))
                .dust()
                .color(0xF9C528)
                .build().setFormula("PdIrReOCeOS", true);

        LithiumAluminiumHydride = new Material.Builder(8227, GTBUtil.gtb("lithium_aluminium_hydride"))
                .dust()
                .color(0xFF5722)
                .build().setFormula("LiAlH4", true);

        PCBS = new Material.Builder(8228, GTBUtil.gtb("pcbs"))
                .fluid()
                .color(0x113B61)
                .build()
                .setFormula("C71H27O5S", true);

        Phosgene = new Material.Builder(8229, GTBUtil.gtb("phosgene"))
                .fluid()
                .color(0x2E7D32)
                .build().setFormula("COCl2", true);

        SilverOxide = new Material.Builder(8230, GTBUtil.gtb("silver_oxide"))
                .dust()
                .color(0xB5B4B7)
                .build()
                .setFormula("AgO2", true);

        BoronFluoride = new Material.Builder(8231, GTBUtil.gtb("boron_fluoride"))
                .fluid()
                .color(0x170E32)
                .build().setFormula("BF2", true);

        SilverChloride = new Material.Builder(8232, GTBUtil.gtb("silver_chloride"))
                .dust()
                .color(0x2A632D)
                .build().setFormula("AgCl", true);

        PCBA = new Material.Builder(8233, GTBUtil.gtb("pcba"))
                .fluid()
                .color(0x8E711A)
                .build().setFormula("C71H28O2", true);

        LithiumIodide = new Material.Builder(8234, GTBUtil.gtb("lithium_iodide"))
                .dust()
                .color(0xDEBDBD)
                .build().setFormula("LiI", true);

        AluminiumHydride = new Material.Builder(8235, GTBUtil.gtb("aluminium_hydride"))
                .dust()
                .color(0x98BEE0)
                .build().setFormula("AlH4", true);

        MagnesiumSulfate = new Material.Builder(8236, GTBUtil.gtb("magnesium_sulfate"))
                .dust()
                .color(0x9A9997)
                .build().setFormula("MgSO4", true);

        PotassiumSulfate = new Material.Builder(8237, GTBUtil.gtb("potassium_sulfate"))
                .dust()
                .color(0xE2C647)
                .build().setFormula("K2SO4", true);

        PotassiumFluoride = new Material.Builder(8238, GTBUtil.gtb("potassium_fluoride"))
                .dust()
                .color(0x737373)
                .build().setFormula("KF", true);

        SodiumFluoride = new Material.Builder(8239, GTBUtil.gtb("sodium_fluoride"))
                .dust()
                .color(0x265583)
                .build().setFormula("NaF", true);
        ...
        Tetradecanol = new Material.Builder(8268, GTBUtil.gtb("tetradecanol"))
                .fluid()
                .color(0x7D311A)
                .build().setFormula("C14H29OH", true);
        ...
        PurifiedScandiumLeachResidues = new Material.Builder(8281,GTBUtil.gtb("purified_scandium_leach_residues"))
                .fluid()
                .color(0x7E57C2)
                .build().setFormula("Sc?", true);

        ExquisiteScandiumLeachResidues = new Material.Builder(8282,GTBUtil.gtb("exquisite_scandium_leach_solution"))
                .fluid()
                .color(0x58447B)
                .build().setFormula("Sc*?", true);
        ...
        RoastedGadoliniteLeachSolution = new Material.Builder(8288,GTBUtil.gtb("roasted_gadolinite_leach_solution"))
                .fluid()
                .color(0x5A4F4D)
                .build().setFormula("Gd(H2O)?", true);
        ...
        CooledGadoliniteLeachSolution = new Material.Builder(8290,GTBUtil.gtb("cooled_gadolinite_leach_solution"))
                .fluid()
                .color(0x8D6E63)
                .build().setFormula("(GdS2)(H2O)", true);
        ...
        SinteredSilver = new Material.Builder(8293, GTBUtil.gtb("sintered_silver"))
                ...
                .flags(GENERATE_ROD)
                .color(0x9D9A9A)
                .build().setFormula("Ag", true);

        VanadiumPentoxide = new Material.Builder(8294, GTBUtil.gtb("vanadium_pentoxide"))
                .dust()
                .color(0x8500A3)
                .build().setFormula("VaO5", true);

        TitaniumDioxide = new Material.Builder(8295, GTBUtil.gtb("titanium_dioxide"))
                .dust()
                .color(0xBA68C8)
                .build().setFormula("TiO2", true);

        GaseousTitaniumTetrachloride = new Material.Builder(8296,GTBUtil.gtb("gaseous_titanium_tetrachloride"))
                .gas()
                .color(0xBA68C8)
                .build().setFormula("TiCl4", true);
        ...
        IronChlorideSolution = new Material.Builder(8304, GTBUtil.gtb("iron_chloride_solution"))
                .fluid()
                .color(0x706f70)
                .build().setFormula("FeCl(H2O)?", true);
        ...
        SodiumChromateSolution = new Material.Builder(8306, GTBUtil.gtb("sodium_chromate_solution"))
                .fluid()
                .color(0xFDD835)
                .build().setFormula("Na2CrO4(H2O)", true);
        ...
        RealgarSolution = new Material.Builder(8314, GTBUtil.gtb("realgar_solution"))
                .fluid()
                .color(0xB83431)
                .build().setFormula("As4S4(H2O)", true);
        ...
        SodiumArsenateSulfuricSolution = new Material.Builder(8325,GTBUtil.gtb("sodium_arsenate_sulfuric_solution"))
                .fluid()
                .color(0x596D78)
                .build().setFormula("NiS2?", true);
        ...
        SodiumIodide = new Material.Builder(8326, GTBUtil.gtb("sodium_iodide"))
                .dust()
                .color(0x07384F)
                .build().setFormula("NaI", true);

        NickelSulfatePrecipitate = new Material.Builder(8327, GTBUtil.gtb("nickel_sulfate_precipitate"))
                .dust()
                .color(0x591B09)
                .build().setFormula("NiS?", true);

        AmmoniaMetalSulfuricSolution = new Material.Builder(8328,GTBUtil.gtb("ammonia_metal_sulfuric_solution"))
                .fluid()
                .color(0x7F67AF)
                .build().setFormula("(NH3)?", true);

        ImpurePitchblendeSlurry = new Material.Builder(8329,GTBUtil.gtb("impure_pitchblende_slurry"))
                .fluid()
                .color(0xE1C441)
                .build();

        SodiumIsopropylXanthate = new Material.Builder(8330,GTBUtil.gtb("sodium_isopropyl_xanthate"))
                .fluid()
                .color(0x8D7924)
                .build().setFormula("C4H7NaOS2", true);

        PitchblendeSlurry = new Material.Builder(8331,GTBUtil.gtb("pitchblende_slurry"))
                .fluid()
                .color(0xC9BA79)
                .build();

        UraniumExtractionMixture = new Material.Builder(8332,GTBUtil.gtb("uranium_extraction_mixture"))
                .fluid()
                .color(0x388E3C)
                .build();

        UraniniteExtract = new Material.Builder(8333,GTBUtil.gtb("uraninite_extract"))
                .fluid()
                .color(0x445045)
                .build();

        UranylSulfide = new Material.Builder(8334,GTBUtil.gtb("uranyl_sulfide"))
                .fluid()
                .color(0x99A043)
                .build().setFormula("UO2S", true);

        AmmoniaSulfateSolution = new Material.Builder(8335,GTBUtil.gtb("ammonia_sulfate_solution"))
                .fluid()
                .color(0xE4B86C)
                .build().setFormula("(NH3)(H2O)S", true);

        PitchblendeFiltrate = new Material.Builder(8336,GTBUtil.gtb("pitchblende_filtrate"))
                .dust()
                .color(0xAFB42B)
                .build().setFormula("?", true);

        UraniumThoriumFiltrate = new Material.Builder(8337,GTBUtil.gtb("uranium_thorium_filtrate"))
                .dust()
                .color(0x4CAF50)
                .build().setFormula("(UO2)(ThO2)?", true);

        LeadMetallicPowder = new Material.Builder(8338,GTBUtil.gtb("lead_metallic_powder"))
                .dust()
                .color(0x977C9E)
                .build().setFormula("Pb?", true);

        UraniumMetallicPowder = new Material.Builder(8339,GTBUtil.gtb("uranium_metallic_powder"))
                .dust()
                .color(0x456D47)
                .build().setFormula("U??", true);

        UraniumResidues = new Material.Builder(8340,GTBUtil.gtb("uranium_residues"))
                .dust()
                .color(0x36736B)
                .build().setFormula("U?", true);

        UraniumDioxide = new Material.Builder(8341,GTBUtil.gtb("uranium_dioxide"))
                .dust()
                .color(0x68886A)
                .build().setFormula("UO2", true);

        CobaltSulfate = new Material.Builder(8342,GTBUtil.gtb("cobalt_sulfate"))
                .dust()
                .color(0x616AA2)
                .build().setFormula("CoSO4", true);

        NickelSulfate = new Material.Builder(8343,GTBUtil.gtb("nickel_sulfate"))
                .dust()
                .color(0xD1C9AE)
                .build().setFormula("NiSO4", true);

        UraniumSolution = new Material.Builder(8344,GTBUtil.gtb("uranium_solution"))
                .fluid()
                .color(0x58935B)
                .build().setFormula("U?", true);

        ThoriumPhosphateCakeSolution = new Material.Builder(8345,GTBUtil.gtb("thorium_phosphate_cake_solution"))
                .fluid()
                .color(0x426845)
                .build().setFormula("Th?", true);

        Alumina = new Material.Builder(8346,GTBUtil.gtb("alumina"))
                .fluid()
                .ingot()
                .ore()
                .dust()
        ...
        DigestedPyrochlore = new Material.Builder(8348,GTBUtil.gtb("digested_pyrochlore"))
                .dust()
                .color(0x3B1F17)
                .build().setFormula("Ca2Nb2O7", true);

        PyrochloreSlurry = new Material.Builder(8349,GTBUtil.gtb("pyrochlore_slurry"))
                .fluid()
                .color(0x48190B)
                .build().setFormula("Ca2Nb2O7", true);

        ImpurePyrochloreSlurry = new Material.Builder(8350,GTBUtil.gtb("impure_pyrochlore_slurry"))
                .fluid()
                .color(0x541907)
                .build().setFormula("Ca2Nb2O7", true);

        ImpureZirconSlurry = new Material.Builder(8351,GTBUtil.gtb("impure_zircon_slurry"))
                .fluid()
                .color(0xB35B5B)
                .build().setFormula("ZrSiO4", true);

        SodiumEthylXanthate = new Material.Builder(8352,GTBUtil.gtb("sodium_ethyl_xanthate"))
                .dust()
                .color(0xBFB669)
                .build().setFormula("CH3CH2OCS2Na", true);

        ZirconSlurry = new Material.Builder(8353,GTBUtil.gtb("zircon_slurry"))
                .fluid()
                .color(0xB25656)
                .build().setFormula("ZrSiO4", true);

        FusedZircon = new Material.Builder(8354,GTBUtil.gtb("fused_zircon"))
                .dust()
                .color(0x842222)
                .build().setFormula("ZrSiO4", true);

        ZirconylChlorideSolution = new Material.Builder(8355,GTBUtil.gtb("zirconyl_chloride_solution"))
                .fluid()
                .color(0x4CAF50)
                .build().setFormula("(ZrOCl2)(HCl)2(H2O)2", true);

        HafniumExtractionMixture = new Material.Builder(8356,GTBUtil.gtb("hafnium_extraction_mixture"))
                .fluid()
                .color(0xEC407A)
                .build();

        PurifiedZirconylChlorideSolution = new Material.Builder(8357,GTBUtil.gtb("purified_zirconyl_chloride_solution"))
                .fluid()
                .color(0x43A047)
                .build().setFormula("(ZrOCl2)(HCl)2(H2O)2", true);

        HafniumExtract = new Material.Builder(8358,GTBUtil.gtb("hafnium_extract"))
                .fluid()
                .color(0xC9A3CF)
                .build();

        HafniumSulfateSolution = new Material.Builder(8359,GTBUtil.gtb("hafnium_sulfate_solution"))
                .fluid()
                .color(0xE1BEE7)
                .build().setFormula("[Hf(SO4)2](H2O)2", true);

        ZirconiumBase = new Material.Builder(8361,GTBUtil.gtb("zirconium_base"))
                .dust()
                .color(0xFAF4C2)
                .build().setFormula("Zr?", true);

        ImpureCelestineSlurry = new Material.Builder(8362,GTBUtil.gtb("impure_celestine_slurry"))
                .fluid()
                .color(0x709BBD)
                .build().setFormula("((?)(SrS))(H2O)(SiO2)", true);

        CelestineSlurry = new Material.Builder(8363,GTBUtil.gtb("celestine_slurry"))
                .fluid()
                .color(0x81A4BF)
                .build();

        StrontiumSulfideSolution = new Material.Builder(8364,GTBUtil.gtb("strontium_sulfide_solution"))
                .fluid()
                .color(0x4F5A63)
                .build().setFormula("(SrS)(H2O)", true);

        StrontiumCarbonate = new Material.Builder(8365,GTBUtil.gtb("strontium_carbonate"))
                .dust()
                .color(0x4CAF50)
                .build().setFormula("SrCO3", true);

        ImpureTantaliteSlurry = new Material.Builder(8366,GTBUtil.gtb("impure_tantalite_slurry"))
                .fluid()
                .color(0x74321D)
                .build().setFormula("MnTa2O6(H2O)?", true);

        TantaliteSlurry = new Material.Builder(8367,GTBUtil.gtb("tantalite_slurry"))
                .fluid()
                .color(0x593428)
                .build().setFormula("MnTa2O6(H2O)", true);

        SodiumBisulfateSolution = new Material.Builder(8368,GTBUtil.gtb("sodium_bisulfate_solution"))
                .fluid()
                .color(0x3F51B5)
                .build().setFormula("(NaHSO4)(H2O)", true);

        EpoxidPCBBase = new Material.Builder(8369,GTBUtil.gtb("epoxid_pcb_base"))
                .fluid()
                .dust()
                .ingot()
                .flags(GENERATE_PLATE)
        ...
        AluminoSilicateWoolSolution = new Material.Builder(8370,GTBUtil.gtb("alumino_silicate_wool_solution"))
                .fluid()
                .color(0x6B757F)
                .build().setFormula("(Al2SiO5)(H2O)", true);

        HighPuritySilicon = new Material.Builder(8371,GTBUtil.gtb("high_purity_silicon"))
                .dust()
                .color(0x574E4E)
                .build().setFormula("Si*", true);

        SiliconTetrachloride = new Material.Builder(8372,GTBUtil.gtb("silicon_tetrachloride"))
                .fluid()
                .color(0x79847A)
                .build().setFormula("SiCl4", true);

        IndiumHydroxide = new Material.Builder(8030,GTBUtil.gtb("indium_hydroxide"))
                .dust()
                .color(0x652F6E)
                .build()
                .setFormula("In(HO)3", true);

        IndiumHydroxideConcentrate = new Material.Builder(8373,GTBUtil.gtb("indium_hydroxide_concentrate"))
                .fluid()
                .color(0x855D8B)
                .build().setFormula("InHO", true);

        IronPoorMixture = new Material.Builder(8374,GTBUtil.gtb("iron_poor_mixture"))
                .fluid()
                .color(0xF4511E)
                .build().setFormula("?In", true);

        ZincPoorMixture = new Material.Builder(8375,GTBUtil.gtb("zinc_poor_mixture"))
                .fluid()
                .color(0x7E57C2)
                .build().setFormula("?Fe", true);

        MetalHydroxideMix = new Material.Builder(8376,GTBUtil.gtb("metal_hydroxide_mix"))
                .fluid()
                .color(0xF5AE52)
                .build().setFormula("?ZnOH", true);

        SeparatedMetalRichSlagSlurry = new Material.Builder(8377,GTBUtil.gtb("separated_metal_rich_slag_slurry"))
                .fluid()
                .color(0x848B91)
                .build().setFormula("H3PO4?", true);

        AcidicMetalRichSlagSlurry = new Material.Builder(8378,GTBUtil.gtb("acidic_metal_rich_slag_slurry"))
                .fluid()
                .color(0x96856C)
                .build().setFormula("H3PO4?", true);

        MetalRichSlagSlurry = new Material.Builder(8379,GTBUtil.gtb("metal_rich_slag_slurry"))
                .fluid()
                .color(0xD9A899)
                .build().setFormula("?", true);

        ZincSlagSlurry = new Material.Builder(8380,GTBUtil.gtb("zinc_slag_slurry"))
                .fluid()
                .color(0xB5B2AE)
                .build().setFormula("?", true);

        ZincResidualSlag = new Material.Builder(8381,GTBUtil.gtb("zinc_residual_slag"))
                .dust()
                .color(0xB8B7B7)
                .build().setFormula("?", true);

        FineZincSlag = new Material.Builder(8382,GTBUtil.gtb("fine_zinc_slag"))
                .dust()
                .color(0xADADAD)
                .build().setFormula("?", true);

        ThalliumSulfateSolution = new Material.Builder(8383,GTBUtil.gtb("thallium_sulfate_solution"))
                .fluid()
                .color(0x8A8F94)
                .build().setFormula("Tl2SO4?", true);

        ThalliumChloride = new Material.Builder(8384,GTBUtil.gtb("thallium_chloride"))
                .dust()
                .color(0xE3F2FD)
                .build().setFormula("TlCl2", true);

        ThalliumResidues = new Material.Builder(8385,GTBUtil.gtb("thallium_residues"))
                .dust()
                .color(0xA970C1)
                .build().setFormula("Tl?", true);

        CadmiumSulfateSolution = new Material.Builder(8386,GTBUtil.gtb("cadmium_sulfate_solution"))
                .fluid()
                .color(0xCFB091)
                .build().setFormula("CdSO4?", true);

        CadmiumThalliumLiqour = new Material.Builder(8387,GTBUtil.gtb("cadmium_thalliun_liqour"))
                .fluid()
                .color(0xA6B5A7)
                .build().setFormula("(H2SO4)CdTl", true);

        ZincAmalgam = new Material.Builder(8388,GTBUtil.gtb("zinc_amalgam"))
                .fluid()
                .color(0x999999)
                .build().setFormula("ZnHg", true);

        CadmiumZinc = new Material.Builder(8389,GTBUtil.gtb("cadmium_zinc"))
                .dust()
                .color(0x726E7E)
                .build().setFormula("(H2SO4)CdZn?", true);

        ZincFlue = new Material.Builder(8390,GTBUtil.gtb("zinc_flue"))
                .dust()
                .iconSet(SAND)
                .color(0xA1A1A0)
                .build().setFormula("?", true);

        ZincExhaustMixture = new Material.Builder(8391,GTBUtil.gtb("zinc_exhaust_mixture"))
                .fluid()
                .color(0x7D7D7C)
                .build().setFormula("(SO2)(CO2)?", true);

        ZincOreCokePellets = new Material.Builder(8392,GTBUtil.gtb("zinc_ore_coke_pellets"))
                .dust()
                .iconSet(ROUGH)
                .color(0x61605A)
                .build().setFormula("(H2O)(ZnS)C", true);

        PreciousMetal = new Material.Builder(8393,GTBUtil.gtb("precious_metal"))
                .dust()
                .ingot()
                .ore()
                .fluid()
                .color(0xAD9B49)
                .build().setFormula("Au?", true);

        StreptococcusPyogenes = new Material.Builder(8394,GTBUtil.gtb("streptococcus_pyogenes"))
                .dust()
                .color(0x61605A)
                .build().setFormula("Bacteria", true);

        EglinSteel = new Material.Builder(8395,GTBUtil.gtb("eglin_steel"))
                .dust()
                .ingot()
                .blast(2900)
                .flags(GENERATE_PLATE, GENERATE_FRAME)
                .color(0xA14919)
                .build().setFormula("(Fe4(FeAlCr)(Fe2Ni)5)10SSiC", true);

        EglinSteelBase = new Material.Builder(8396,GTBUtil.gtb("eglin_steel_base"))
                .dust()
                .color(0xAD7150)
                .build().setFormula("Fe4(FeAlCr)(Fe2Ni)5", true);

        LowQualitySteel = new Material.Builder(8397,GTBUtil.gtb("low_quality_steel"))
                .dust()
                .ingot()
                .flags(GENERATE_PLATE, GENERATE_FRAME)
                .color(0x434343)
                .build().setFormula("Fe20C", true);
        ...
        Hydroquinone = new Material.Builder(8399,GTBUtil.gtb("hydroquinone"))
                .fluid()
                .color(0x9e3123)
                .build().setFormula("C6H4(OH)2", true);

        DeionizedPalladium = new Material.Builder(8400,GTBUtil.gtb("deionized_palladium"))
                .dust()
                .iconSet(SHINY)
                .color(0xDFDFDF)
                .build().setFormula("Pd(NH3)H2O", true);

        DriedPalladium = new Material.Builder(8401,GTBUtil.gtb("dried_palladium"))
                .dust()
                .iconSet(DULL)
                .color(0xDFDFDF)
                .build().setFormula("Pd(NH3)", true);

        RichAmine = new Material.Builder(8402,GTBUtil.gtb("rich_amine"))
                .fluid()
                .color(0x3C3C3C)
                .build().setFormula("?", true);

        DeionizedWater = new Material.Builder(8403,GTBUtil.gtb("deionized_water"))
                .fluid()
                .color(0x1C5480)
                .build().setFormula("H2O", true);

        DeaeratedWater = new Material.Builder(8404,GTBUtil.gtb("deaerated_water"))
                .fluid()
                .color(0x7FABCE)
                .build().setFormula("H2O", true);

        DemineralizedWater = new Material.Builder(8405,GTBUtil.gtb("demineralized_water"))
                .fluid()
                .color(0x7AA1C0)
                .build().setFormula("H2O", true);

        WaterPlasma = new Material.Builder(8406,GTBUtil.gtb("water_plasma"))
                .plasma()
                .color(0xB3D1EC)
                .build().setFormula("H2O", true);

        UltrapureWater = new Material.Builder(8407,GTBUtil.gtb("ultrapure_water"))
                .fluid()
                .color(0xC3DFF5)
                .build().setFormula("H2O", true);

        HighPressureUltrapureWaterGrade1 = new Material.Builder(8408,GTBUtil.gtb("high_pressure_ultrapure_water_grade_1"))
                .fluid()
                .color(0x73A6D8)
                .build().setFormula("H2O", true);

        SupercriticalUltrapureWaterGrade1 = new Material.Builder(8409,GTBUtil.gtb("supercritical_ultrapure_water_grade_1"))
                .fluid()
                .color(0x98BDE4)
                .build().setFormula("H2O", true);

        UltrapureWaterGrade1 = new Material.Builder(8410,GTBUtil.gtb("ultrapure_water_grade_1"))
                .fluid()
                .color(0xB6D1ED)
                .build().setFormula("H2O", true);

        UltrapureWaterGrade2 = new Material.Builder(8411,GTBUtil.gtb("ultrapure_water_grade_2"))
                .fluid()
                .color(0xBBD4EE)
                .build().setFormula("H2O", true);

        UltrapureWaterGrade3 = new Material.Builder(8412,GTBUtil.gtb("ultrapure_water_grade_3"))
                .fluid()
                .color(0xC3DAF1)
                .build().setFormula("H2O", true);

        UltrapureWaterGrade4 = new Material.Builder(8413,GTBUtil.gtb("ultrapure_water_grade_4"))
                .fluid()
                .color(0xC7DCF0)
                .build().setFormula("H2O", true);

        UltrapureWaterGrade5 = new Material.Builder(8414,GTBUtil.gtb("ultrapure_water_grade_5"))
                .fluid()
                .color(0xCEE1F4).build()
                .setFormula("H2O", true);

        UltrapureWaterGrade6 = new Material.Builder(8415,GTBUtil.gtb("ultrapure_water_grade_6"))
                .fluid()
                .color(0xD2E2F3)
                .build().setFormula("H2O", true);

        UltrapureWaterGrade7 = new Material.Builder(8416,GTBUtil.gtb("ultrapure_water_grade_7"))
                .fluid()
                .color(0xD9E7F5)
                .build().setFormula("H2O", true);

        UltrapureWaterGrade8 = new Material.Builder(8417,GTBUtil.gtb("ultrapure_water_grade_8"))
                .fluid()
                .color(0xE5EDF3)
                .build().setFormula("H2O", true);

        SterilizedWater = new Material.Builder(8418,GTBUtil.gtb("sterilized_water"))
                .fluid()
                .color(0x81B5DC)
                .build().setFormula("H2O", true);

        MolecularSieve = new Material.Builder(8419,GTBUtil.gtb("molecular_sieve"))
                .dust()
                .iconSet(SHINY)
                .color(0x666666)
                .build();

        ImpurePolluciteSlurry = new Material.Builder(8420,GTBUtil.gtb("impure_pollucite_slurry"))
                .fluid()
                .color(0xC5C0BE)
                .build();

        Oleic_Acid = new Material.Builder(8421,GTBUtil.gtb("oleic_acid"))
                .fluid()
                .dust()
                .color(0xA9C885)
                .build().setFormula("C18H34O2", true);

        SodiumSilicate = new Material.Builder(8422, GTBUtil.gtb("sodium_silicate"))
                .dust()
                .color(0x8E9798)
                .build().setFormula("Na2OSiO2", true);
        ...
        Difluorobenzophenone = new Material.Builder(8424, GTBUtil.gtb("difluorobenzophenone"))
                .fluid()
                .color(0x31AABA)
                .build().setFormula("C13H8OF2", true);
        ...
        SodiumThiosulfate = new Material.Builder(8589, GTBUtil.gtb("sodium_thiosulfate"))
                .dust()
                .color(0xA594C3)
                .build().setFormula("Na2S2O3", true);

        SodiumSulfite = new Material.Builder(8590, GTBUtil.gtb("sodium_sulfite"))
                .dust()
                .color(0xD8D18E)
                .build().setFormula("Na2SO3", true);

        Polonium = new Material.Builder(8591, GTBUtil.gtb("polonium"))
                .dust()
                .color(0xA7C5A8)
                .build().setFormula("Po", true);

        HighPurityTantalum = new Material.Builder(8593, GTBUtil.gtb("high_purity_tantalum"))
                .dust()
                .ingot()
                .iconSet(SHINY)
                .flags(GENERATE_ROD)
                .color(0x659BC9)
                .build().setFormula("Ta*", true);

        TantalumNitride = new Material.Builder(8594, GTBUtil.gtb("tantalum_nitride"))
                .dust()
                .iconSet(SHINY)
                .color(0x659BC9)
                .build().setFormula("TaN", true);

        BismuthTelluride = new Material.Builder(8596, GTBUtil.gtb("bismuth_telluride"))
                .dust()
                .ingot()
                .color(0x6D816D)
        ...
        Ytterbium = new Material.Builder(8597, GTBUtil.gtb("ytterbium"))
                ...
                .ingot()
                .color(0x79886F)
                .build().setFormula("Yb", true);

        LeadNitrateSolution = new Material.Builder(8598, GTBUtil.gtb("lead_nitrate_solution"))
                .fluid()
                .color(0xA586AD)
                .build().setFormula("Pb(NO3)2(H2O)", true);
