...
public class FirstDegreeMaterials {
  ...
  public static void register() {
        ...
        HydrogenatedCarbontetrafluoride = new Material.Builder(8144,GTBUtil.gtb("hydrogenated_carbon_tetrafluoride"))
                .fluid()
                .color(0x788C79)
        ...
        Zircon = new Material.Builder(8347,GTBUtil.gtb("zircon"))
                .fluid()
        ...
        HafniumDioxide = new Material.Builder(8360,GTBUtil.gtb("hafnium_dioxide"))
                .dust()
                .color(0xCAC3CC)
                .build().setFormula("HfO2", true);
