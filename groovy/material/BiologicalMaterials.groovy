...
public class BiologicalMaterials {
  ...
  public static void register() {
        ...
        DepletedBacterialGrowthMedium = new Material.Builder(12003,GTBUtil.gtb("depleted_bacterial_growth_medium"))
                .fluid()
                .color(0x376B3B)
                .build().setFormula("For Bacteria", true);
        ...
        BasicFibroblastGrowthMedium = new Material.Builder(12008,GTBUtil.gtb("basic_fibroglast_growth_medium"))
                .fluid()
                .color(0x8C52A5)
        ...
        YeastExtractMannitolAgarSolution = new Material.Builder(12037,GTBUtil.gtb("yeast_extract_mannitol_agar_solution"))
                .fluid()
                .color(0x7D4C9A)
                .build().setFormula("[(C6H14O6)(?)]r", true);

        DissolvedYeastExtractMannitolMixture = new Material.Builder(12038,GTBUtil.gtb("dissolved_yeast_extract_mannitol_mixture"))
                .fluid()
                .color(0x1565C0)
        ...
        SolidifiedSterileDefibernatedSheepBlood = new Material.Builder(12064,GTBUtil.gtb("solidified_sterile_defibernated_sheep_blood"))
                .dust()
                .color(0xEF9A9A)
                .build().setFormula("?", true);

        DissolvedPhenylEthylAlcoholAgar = new Material.Builder(12065,GTBUtil.gtb("dissolved_phenyl_ethyl_alcohol_agar"))
                .fluid()
                .color(0x974B74)
                .build().setFormula("(H2O)(C8H10O)(?)", true);

        PhenylEthylAlcoholAgarSolution = new Material.Builder(12066,GTBUtil.gtb("phenyl_ethyl_alcohol_agar_solution"))
                .fluid()
                .color(0x913867)
        ...
        OrthophosphoricAcidSolution = new Material.Builder(12084,GTBUtil.gtb("orthophosphoric_acid_solution"))
                .fluid()
                .color(0xA89A60)
